...
public:
	...
	virtual sql::ResultSet * GetSourceDBForScnRefresh();
	virtual bool UpdateNowScn(string now_scn, string sid);
	
	virtual bool UpdateNowTime(string now_time, string sid);
	virtual sql::ResultSet * GetSourceDBBySID(string sid);
	virtual bool UpdateCheckScn(string scn, string sid);
	//add 20170619
	virtual int GetCountResultSetFromTEMP(string sid);
	virtual sql::ResultSet * GetSourceDB_SID();
	virtual bool CheckCommitAndInsertDelete(string souceId);
	virtual sql::ResultSet * GetXIDBYOPERATION_CODE(string souceId);
	virtual bool CheckByXID_InsertDelete(string souceId,string XId);
	virtual bool DeleteNotCommitDB(string source);
	#endif
...
private:
	...
	#if 1
	virtual sql::ResultSet * GetStrantegyDBResultSet(string sourceid);
	virtual sql::ResultSet * GetMaxPidByStrantegyIDResultSet(string strantegyid);
	virtual sql::ResultSet * GetCountPidBySourceIDResultSet(string source);
	
	virtual sql::ResultSet * GetMinPidBySourceIDResultSet(string source);
