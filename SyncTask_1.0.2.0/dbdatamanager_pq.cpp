 ...
 *      无
 */
DbDataManager_PQ::DbDataManager_PQ(string server, string user, string password, string dbname)
{
 ...
 *      无
 */
DbDataManager_PQ::~DbDataManager_PQ()
{
}
 ...
 */
bool DbDataManager_PQ::AddTask(string cmdheader, string cmdcode, string parameter, DbDataManager_PQ::TaskState state, DbDataManager_PQ::TaskResult result, string faildesc)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteTask(string hcode)
{
 ...
 */
bool DbDataManager_PQ::UpdateTaskHeaderAndStatus(string taskid, string cmdheader)
{
 ...
 */
 #if 0
bool DbDataManager_PQ::UpdateTaskStatus(string taskid, DbDataManager_PQ::TaskState state, DbDataManager_PQ::TaskResult result)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateTaskStatus(string taskid, DbDataManager_PQ::TaskState state, DbDataManager_PQ::TaskResult result, string faildesc)
{
    if (BeGeneralLib::IsStringEmptyOrZero(taskid) == true)
    {
        return true;
...
bool DbDataManager_PQ::UpdateStrategyStatus(string sor_str_id,string taskname)
{
	
    string SqlString ;
	if(taskname=="extractor")
	{
		SqlString = string("UPDATE TBL_STRATEGY SET CAP_STATE = 0 WHERE SID=") + sor_str_id;
	}
	else if(taskname=="loader")
	{
		SqlString = string("UPDATE TBL_STRATEGY SET LOAD_STATE = 0 WHERE STRATEGY_ID=") + sor_str_id;
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateTaskStateDesc(string taskid, string desc)
{
    if (BeGeneralLib::IsStringEmptyOrZero(taskid) == true)
    {
        return true;
 ...
 *      任务结果集
 */
pqxx::result DbDataManager_PQ::GetTaskResultSet(TaskState state)
{
 ...
 *      license更新任务字段
 */
map<string, string> DbDataManager_PQ::GetLicenseUpdateTask()
{
 ...
 *      任务记录字段
 */
map<string, string> DbDataManager_PQ::GetTaskRecord(string taskid)
{
 ...
 *      任务超时时间
 */
int DbDataManager_PQ::GetTaskTimeout(string taskid)
{
    if (BeGeneralLib::IsStringEmptyOrZero(taskid) == true)
    {
        return 0;
 ...
 *      任务结果集
 */
pqxx::result DbDataManager_PQ::GetDeleteHostTask()
{
 ...
 *      任务状态
 */
DbDataManager_PQ::TaskState DbDataManager_PQ::GetTaskState(string taskid)
{
    string SqlString = string("SELECT STATUS FROM TBL_TASK WHERE TASKID = ") + taskid;
    return (DbDataManager_PQ::TaskState)(GetFieldValueInt(SqlString, "STATUS"));
}
 ...
 *      任务id
 */
string DbDataManager_PQ::GetTaskId(string cmdheader)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::HasUncompletedTask()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateEmergencyCopyId(string hcode, string strategyid, string copyid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateTrustedCopyId(string hcode, string strategyid, string copyid)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCDPProtectionState(string hcode, string strategyid, int protectionstate)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      网启id
 */
string DbDataManager_PQ::GetEmergencyCopyId(string hcode, string volumesymbol)
{
 ...
 *      网启副本id
 */
string DbDataManager_PQ::GetSystemEmergencyCopyId(string hcode)
{
 ...
 *      可信副本id
 */
string DbDataManager_PQ::GetTrustedCopyId(string hcode, string volumesymbol)
{
    return GetStrategyFieldValue(hcode, volumesymbol, DbDataManager_PQ::STRATEGY_TABLE_FIELD_TRUSTEDCOPYID);
}
 ...
 *      系统盘可信副本id
 */
string DbDataManager_PQ::GetSystemTrustedCopyId(string hcode)
{
 ...
 *      主机网启结果集
 */
pqxx::result DbDataManager_PQ::GetHostEmbootResultSet()
{
 ...
 *      获取的主机挂载点
 */
string DbDataManager_PQ::GetHostMountPoint(string hcode, string strategyid)
{
 ...
 *      CDP状态
 */
DbDataManager_PQ::CDPState DbDataManager_PQ::GetStrategyCDPState(string hcode, string strategyid)
{
    return (DbDataManager_PQ::CDPState)(BeGeneralLib::StringToInt(GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_CDPSTATE)));
}
 ...
 *      CDP模式
 */
DbDataManager_PQ::CDPMode DbDataManager_PQ::GetStrategyCDPMode(string hcode, string strategyid)
{
    return (DbDataManager_PQ::CDPMode)(BeGeneralLib::StringToInt(GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_CDPMODE)));
}
 ...
 *      设备号
 */
string DbDataManager_PQ::GetStrategyDeviceMinor(string hcode, string strategyid)
{
    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_DEVICEMINOR);
}
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyUsedForCDP(string hcode, string strategyid)
{
    return BeGeneralLib::StringToBool(GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_USEDFORCDP));
}
 ...
 */
bool DbDataManager_PQ::AddVolume(string hcode, string device, string lmountpoint, string volumetype, string capacity, string usedspace, string isbootvolume)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateVolume(string hcode, string device, string mountpoint, string volumetype, string capacity, string usedspace, string isbootvolume)
{
 ...
 *      盘符文件系统
 */
string DbDataManager_PQ::GetVolumeFileSystem(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      主机卷结果集
 */
pqxx::result DbDataManager_PQ::GetVolumeResultSet(string hcode)
{
 ...
 *      磁盘已用空间大小
 */
string DbDataManager_PQ::GetVolumeUsedSpace(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      卷对应的设备
 */
string DbDataManager_PQ::GetVolumeDevice(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsVolumeSymbolExist(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsBootPartitionType(string hcode, string volumesymbol)
{
    bool Flag = false;
    ...
    switch (GetHostOSType(hcode))
    {
        ...
        case DbDataManager_PQ::HOST_OS_TYPE_AIX:
        case DbDataManager_PQ::HOST_OS_TYPE_HPUX:
        {
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddCopyRecord(string snapshotid, string hcode, string volumesymbol, DbDataManager_PQ::CopyType type)
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddCopyRecord(string snapshotid, string hcode, string volumesymbol, string copylunid, DbDataManager_PQ::CopyType type)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddCopyRecord(string snapshotid, string hcode, string volumesymbol, string used, string iqn, string mountpoint, string copyid)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
    string Capacity = GetVolumeCapacity(hcode, LMountPoint);
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteCopy(string hcode, string copyid)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteCopySet(string hcode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopyStatus(string hcode, string copyid, DbDataManager_PQ::CopyState state)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopyRootPath(string copypath)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopy(string hcode, string copyid, string iqn, string mountpoint, string targetfile)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopySnapshotId(string hcode, string copyid, string snapshotid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopyLunId(string hcode, string copyid, string copylunid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopySenderCopyId(string hcode, string copyid, string sendercopyid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopyFsName(string hcode, string copyid, string fsname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCopyLoopDevice(string hcode, string copyid, string loopdevice)
{
 ...
 *      副本ID
 */
string DbDataManager_PQ::GetCopyId(string hcode, string value, DbDataManager_PQ::CopyIDRetrieveType type)
{
    string SqlString = "";
    switch (type)
    {
        case DbDataManager_PQ::COPY_ID_RETRIEVE_TYPE_SNAPSHOTID:
        {
            SqlString = string("SELECT SSCOPYID FROM TBLSNAPSHOTCOPY WHERE SNAPSHOTID =") + value;
            break;
        }
        case DbDataManager_PQ::COPY_ID_RETRIEVE_TYPE_IQN:
        {
 ...
 *      副本结果集
 */
pqxx::result DbDataManager_PQ::GetCopyResultSet(string hcode, string volumesymbol)
{
 ...
 *      副本结果集
 */
pqxx::result DbDataManager_PQ::GetCopyResultSet(string hcode)
{
 ...
 *      副本记录字段值
 */
map<string, string> DbDataManager_PQ::GetCopyFieldValue(string hcode, string copyid)
{
    vector<string> FieldList;
 ...
 *      副本零id
 */
string DbDataManager_PQ::GetZeroCopyId(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      最新副本id
 */
string DbDataManager_PQ::GetFinalCopyId(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      主机网启结果集
 */
pqxx::result DbDataManager_PQ::GetNonSystemEmergencyCopyResultSet(string hcode)
{
 ...
 *      应急副本结果集
 */
pqxx::result DbDataManager_PQ::GetTimingSnapshotEmergencyCopyResultSet()
{
 ...
 *      副本根路径
 */
string DbDataManager_PQ::GetCopyRootPath()
{
 ...
 *      副本lunid
 */
string DbDataManager_PQ::GetCopyLunId(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_COPYLUNID);
}
 ...
 *      副本记录的快照id
 */
string DbDataManager_PQ::GetCopySnapshotId(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_SNAPSHOTID);
}
 ...
 *      副本类新
 */
DbDataManager_PQ::CopyType DbDataManager_PQ::GetCopyType(string hcode, string copyid)
{
    return (DbDataManager_PQ::CopyType)(BeGeneralLib::StringToInt(GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_COPYTYPE)));
}
 ...
 *      副本iqn
 */
string DbDataManager_PQ::GetCopyIqn(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_IQN);
}
 ...
 *      副本target文件
 */
string DbDataManager_PQ::GetCopyTargetFile(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_TARGETFILE);
}
 ...
 *      副本对应的卷标识
 */
string DbDataManager_PQ::GetCopyLMountPoint(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_LMOUNTPOINT);
}
 ...
 *      副本挂载点
 */
string DbDataManager_PQ::GetCopyMountPoint(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_MOUNTPOINT);
}
 ...
 *      副本个数
 */
int DbDataManager_PQ::GetCopyCountWithType(string hcode, DbDataManager_PQ::CopyType type)
{
    // 检查输入的有效性
 ...
 *      副本状态
 */
DbDataManager_PQ::CopyState DbDataManager_PQ::GetCopyState(string hcode, string copyid)
{
    return (DbDataManager_PQ::CopyState)(BeGeneralLib::StringToInt(GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_USED)));
}
 ...
 *      发送端副本编号
 */
string DbDataManager_PQ::GetCopySenderCopyId(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_SENDERCOPYID);
}
 ...
 *      副本容量
 */
int DbDataManager_PQ::GetCopyCapacity(string hcode, string copyid)
{
    return BeGeneralLib::StringToInt(GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_CAPACITY));
}
 ...
 *      副本容量
 */
string DbDataManager_PQ::GetCopyFsName(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_FSNAME);
}
 ...
 *      loop设备名称
 */
string DbDataManager_PQ::GetCopyLoopDevice(string hcode, string copyid)
{
    return GetCopyFieldValue(hcode, copyid, DbDataManager_PQ::COPY_TABLE_FIELD_LOOPDEVICENAME);
}
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsCopyAsEmergencyCopy(string hcode, string copyid)
{
    // 检查输入的有效性
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsCopyExist(string hcode, string copyid)
{
    // 检查输入的有效性
    if (BeGeneralLib::IsStringEmptyOrInvalidValue(hcode) == true || BeGeneralLib::IsStringEmptyOrZero(copyid) == true)
    {
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostHasCopyUsed(string hcode)
{
    if (BeGeneralLib::IsStringEmptyOrInvalidValue(hcode) == true)
    {
        return false;
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsVolumeHasCopyUsed(string hcode, string volumesymbol)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsCopyUsed(string hcode, string copyid)
{
    return (GetCopyState(hcode, copyid) == DbDataManager_PQ::COPY_STATE_USED);
}
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddSnapshotRecord(string hcode, string volumesymbol, DbDataManager_PQ::SnapType type)
{
    // 检查输入值是否为空
    ...
    // 获取策略编号
    string StrategyId = GetStrategyId(hcode, volumesymbol, DbDataManager_PQ::STRATEGY_ID_SEARCH_TYPE_LMOUNTPOINT);
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddSnapshotRecord(string hcode, string volumesymbol, DbDataManager_PQ::SnapType type, string starttime, string endtime, string checkpointid, DbDataManager_PQ::SnapshotSource source, string synccopyid)
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddSnapshotRecord(string hcode, string volumesymbol, string snapshottype, string starttime, string endtime, string checkpointid, DbDataManager_PQ::SnapshotSource source, string synccopyid)
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddSnapshotRecord(string hcode, string volumesymbol, string snapshottype, string starttime, string endtime, string checkpointid, string source, string synccopyid)
{
    // 检查输入值是否为空
    if (BeGeneralLib::IsStringEmptyOrZero(hcode) == true || BeGeneralLib::IsStringEmptyOrZero(volumesymbol) == true)
    {
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteSnapshot(string hcode, string snapshotid)
{
    // 检查输入值是否为空
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteZeroSnapshot(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteAllSnapshot(string hcode)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteFinalSnapshot(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSnapshotRootPath(string snapshotpath)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateFinalSnapshotEndTime(string hcode, string volumesymbol, string snapshotlunid)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSnapshotTrusted(string hcode, string snapshotid, bool trustedflag)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSnapshotEndTime(string hcode, string snapshotid, string copyid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSnapshotEndTime(string hcode, string snapshotid, string copyid, string endtime, string checkpointid, DbDataManager_PQ::SnapshotSource source)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSnapshotSyncState(string hcode, string snapshotid, DbDataManager_PQ::SnapshotSyncState state)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSnapshotSyncStateBySyncCopyId(string hcode, string synccopyid, DbDataManager_PQ::SnapshotSyncState state)
{
 ...
 *      快照根路径
 */
string DbDataManager_PQ::GetSnapshotRootPath()
{
 ...
 *      快照个数
 */
int DbDataManager_PQ::GetSnapshotCount(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      快照零id
 */
string DbDataManager_PQ::GetZeroSnapshotId(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      快照id
 */
string DbDataManager_PQ::GetFinalSnapshotId(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      快照lunid
 */
string DbDataManager_PQ::GetSnapshotLunId(string hcode, string snapshotid)
{
    return GetSnapshotFieldValue(hcode, snapshotid, DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SNAPSHOTLUNID);
}
 ...
 *      快照结果集
 */
pqxx::result DbDataManager_PQ::GetSnapshotResultSet(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      快照结果集
 */
pqxx::result DbDataManager_PQ::GetSnapshotResultSet(string hcode)
{
 ...
 *      快照结果集
 */
pqxx::result DbDataManager_PQ::GetSnapshotResultSet(string hcode, string volumesymbol, DbDataManager_PQ::SnapshotSyncState state, string syncopyid)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      快照结果集
 */
pqxx::result DbDataManager_PQ::GetSnapshotResultSet(string hcode, string volumesymbol, string syncopyid)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      快照结束时间
 */
string DbDataManager_PQ::GetSnapshotEndTime(string hcode, string snapshotid)
{
    return GetSnapshotFieldValue(hcode, snapshotid, DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_ENDTIME);
}
 ...
 *      快照对应的checkpoint编号
 */
string DbDataManager_PQ::GetSnapshotCheckPointId(string hcode, string snapshotid)
{
    return GetSnapshotFieldValue(hcode, snapshotid, DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_CHECKPOINTID);
}
 ...
 *      快照同步副本id
 */
string DbDataManager_PQ::GetSnapshotSyncCopyId(string hcode, string snapshotid)
{
    return GetSnapshotFieldValue(hcode, snapshotid, DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SYNCCOPYID);
}
 ...
 *      远程同步状态
 */
DbDataManager_PQ::SnapshotSyncState DbDataManager_PQ::GetSnapshotSyncState(string hcode, string snapshotid)
{
    return (DbDataManager_PQ::SnapshotSyncState)(BeGeneralLib::StringToInt(GetSnapshotFieldValue(hcode, snapshotid, DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SYNCSTATE)));
}
 ...
 *      快照记录字段值
 */
map<string, string> DbDataManager_PQ::GetSnapshotFieldValue(string hcode, string snapshotid)
{
    vector<string> FieldList;
    FieldList.push_back("SNAPSHOTID");
 ...
 *      快照记录字段值
 */
string DbDataManager_PQ::GetLastSyncSnapshotId(string hcode, string volumesymbol, string synccopyid)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
    string SqlString = string("SELECT MAX(SNAPSHOTID) AS SNAPSHOTID FROM TBLSNAPSHOT WHERE HCODE = '") + hcode + string("' AND LMOUNTPOINT = '") + LMountPoint + string("' AND SYNCCOPYID = ") + synccopyid + string(" AND SYNCSTATE = ") + BeGeneralLib::Number2String(DbDataManager_PQ::SNAPSHOT_SYNC_STATE_COMPLETED);
    return GetFieldValue(SqlString, "SNAPSHOTID");
}
 ...
 *      快照id
 */
string DbDataManager_PQ::GetSnapshotId(string hcode, string volumesymbol, string synccopyid, string starttime, string endtime)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 */
bool DbDataManager_PQ::IsZeroSnapshot(string hcode, string snapshotid)
{
 ...
 */
bool DbDataManager_PQ::IsZeroSnapshotExist(string hcode, string volumesymbol)
{
    string LMountPoint = GetHostMountPoint(hcode, volumesymbol);
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsSnapshotExist(string hcode, string snapshotid)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsSnapshotExist(string hcode, string lmountpoint, string starttime, string endtime, string synccopyid)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsFinalSnapshot(string hcode, string snapshotid)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsSnapshotHasCopy(string hcode, string snapshotid)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsTrustedSnapshot(string hcode, string snapshotid)
{
 ...
 *      快照类型字符串
 */
string DbDataManager_PQ::GetSnapshotTypeString(DbDataManager_PQ::SnapType type)
{
    // 获取快照类型
    string SnapshotTypeString = "";
    switch (type)
    {
        case DbDataManager_PQ::SNAPSHOT_TYPE_ZERO:
        {
            SnapshotTypeString = string("Z");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TYPE_VOLUME:
        {
            SnapshotTypeString = string("V");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TYPE_DATABASE:
        {
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddStrategy(string hcode, string lmountpoint, string name, string type, string capacity, string copyid)
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddStrategy(string localserverid, string remoteserverid, string hcode, string lmountpoint, string name, string type, string isfullcopy, string iqn,
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddStrategyDetail(string localserverid, string remoteserverid, string strategyid, string scheduleid, string groupid, string operation, string foldername)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteStrategy(string hcode, string strategyid)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteStrategySet(string hcode)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteStrategyDetail(string strategyid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategy(string localserverid, string remoteserverid, string hcode, string lmountpoint, string name, string type, string isfullcopy, string iqn,
        string targetfile, string mountpoint, string capacity, string mirrorlunid, string mmlunid, string volumepairid, string lvn, string rvn, string lvoltag, string rvoltag,
        string usedforcdp, string cdpstate, string maxsnapshot, string usedfortimeout, string copytimeout, string cdpmode, string datasource, string deviceminor)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyAndDetailServerId(string hcode, string strategyid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyAndDetailServerId(string hcode, string strategyid, string localserverid, string remoteserverid)
{
    string SqlString = DEFAULT_EMPTY_STRING;
    vector<string> SqlList;
    string StrategyId = GetStrategyId(hcode, strategyid, DbDataManager_PQ::STRATEGY_ID_SEARCH_TYPE_LMOUNTPOINT);
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyMirrorVolumeId(string strategyid, string volumeid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyMMVolumeId(string strategyid, string volumeid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyVolumePairId(string strategyid, string pairid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyStorageId(string strategyid, string storageid)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyVolumeCapacity(string strategyid, string newcapacity)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStrategyDeviceMinor(string strategyid, string deviceminor)
{
...
/*
sql::ResultSet * DbDataManager_PQ::GetStrategyResultSet()
{
 ...
 *      复制策略结果集
 */
pqxx::result DbDataManager_PQ::GetStrategyResultSet(string hcode)
{
    return GetStrategyResultSet(hcode, DbDataManager_PQ::STRATEGY_TYPE_UNKNOWN);
}
 ...
 *      复制策略结果集
 */
pqxx::result DbDataManager_PQ::GetStrategyResultSet(string hcode, StrategyType strategytype)
{
    string TypeCode = "";

    switch (strategytype)
    {
        case DbDataManager_PQ::STRATEGY_TYPE_SYSTEM:
        {
            TypeCode = "S";
            break;
        }
        case DbDataManager_PQ::STRATEGY_TYPE_DATA:
        {
            TypeCode = "D";
            break;
        }
        case DbDataManager_PQ::STRATEGY_TYPE_RAC:
        {
            TypeCode = "R";
            break;
        }
        case DbDataManager_PQ::STRATEGY_TYPE_DB:
        {
            TypeCode = "B";
            break;
        }
 ...
 *      复制策略明细结果集
 */
pqxx::result DbDataManager_PQ::GetStrategyDetailResultSet(string strategyid)
{
 ...
 *      复制策略明细结果集
 */
pqxx::result DbDataManager_PQ::GetStrategyDetailResultSet(string strategyid, string scheduleid)
{
 ...
 *      复制策略明细结果集
 */
pqxx::result DbDataManager_PQ::GetStrategyDetailResultSet(string strategyid, string scheduleid, DbDataManager_PQ::DetailType type)
{
    string Operation = "";
    if ((type & DbDataManager_PQ::DETAIL_TYPE_INCLUDE) == DbDataManager_PQ::DETAIL_TYPE_INCLUDE)
    {
        Operation = string(" OPERATION = '+' ");
    }
    if ((type & DbDataManager_PQ::DETAIL_TYPE_EXCLUDE) == DbDataManager_PQ::DETAIL_TYPE_EXCLUDE)
    {
    ...
    if ((type & DbDataManager_PQ::DETAIL_TYPE_DATABASE) == DbDataManager_PQ::DETAIL_TYPE_DATABASE)
    {
        if (BeGeneralLib::IsStringEmpty(Operation) == false)
        {
            Operation = Operation + string(" OR ");
 ...
 *      复制策略明细结果集
 */
pqxx::result DbDataManager_PQ::GetStrategyDetailResultSet(string strategyid, DbDataManager_PQ::DetailType type)
{
    string Operation = "";
    if ((type & DbDataManager_PQ::DETAIL_TYPE_INCLUDE) == DbDataManager_PQ::DETAIL_TYPE_INCLUDE)
    {
 ...
 *      复制策略id
 */
string DbDataManager_PQ::GetStrategyId(string hcode, string condition, DbDataManager_PQ::StrategyIdSearchType type)
{
    string SqlString = "";
    switch (type)
    {
        case DbDataManager_PQ::STRATEGY_ID_SEARCH_TYPE_LMOUNTPOINT: // 本地挂载点
        {
        ...
        case DbDataManager_PQ::STRATEGY_ID_SEARCH_TYPE_SNAPSHOTID: // 快照id
        {
 ...
 *      卷指定容量
 */
string DbDataManager_PQ::GetVolumeCapacity(string hcode, string volumesymbol)
{
    return GetStrategyFieldValue(hcode, volumesymbol, DbDataManager_PQ::STRATEGY_TABLE_FIELD_CAPACITY);
}
 ...
 *      镜像卷id
 */
string DbDataManager_PQ::GetMirrorLunId(string hcode, string strategyid)
{

    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_MIRRORLUNID);
}
 ...
 *      镜像卷的镜像卷id
 */
string DbDataManager_PQ::GetMMLunId(string hcode, string strategyid)
{

    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_MMLUNID);
}
 ...
 *      镜像卷对id
 */
string DbDataManager_PQ::GetVolumePairId(string hcode, string strategyid)
{

    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_VOLUMEPAIRID);
}
 ...
 *      当前卷类型
 */
DbDataManager_PQ::VolumeType DbDataManager_PQ::GetCurrentVolumeType(string hcode, string strategyid)
{
    return (DbDataManager_PQ::VolumeType)(BeGeneralLib::StringToInt(GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_CURRENTVOLUMETYPE)));
}
 ...
 *      策略存储路径
 */
string DbDataManager_PQ::GetStrategyStoragePath(string hcode, string strategyid)
{
    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_STG_MOUNTPOINT);
}
 ...
 *      策略存储id
 */
string DbDataManager_PQ::GetStrategyStorageId(string hcode, string strategyid)
{

    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_STGID);
}
 ...
 *      策略存储id
 */
string DbDataManager_PQ::GetStrategyStorageDevice(string hcode, string strategyid)
{

    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_STG_DEVICE);
}
 ...
 *      策略存储文件系统
 */
string DbDataManager_PQ::GetStrategyStorageFileSystem(string hcode, string strategyid)
{
    return GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_STG_FSTYPE);
}
 ...
 *      策略最大快照数
 */
int DbDataManager_PQ::GetStrategyMaxSnapshot(string hcode, string strategyid)
{
    return BeGeneralLib::StringToInt(GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_MAXSNAPSHOT));
}
 ...
 *      CDP个数
 */
int DbDataManager_PQ::GetCDPCount()
{
    return GetCDPCount("", "");
}
 ...
 *      CDP个数
 */
int DbDataManager_PQ::GetCDPCount(string hcode, string strategyid)
{
 ...
 *      策略类型
 */
DbDataManager_PQ::StrategyType DbDataManager_PQ::GetStrategyType(string hcode, string strategyid)
{
    string StrategyType = GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_STRATEGYTYPE);
    if (StrategyType == "S")
    {
        return DbDataManager_PQ::STRATEGY_TYPE_SYSTEM;
    }
    else if (StrategyType == "R")
    {
        return DbDataManager_PQ::STRATEGY_TYPE_RAC;
    }
    else if (StrategyType == "B")
    {
        return DbDataManager_PQ::STRATEGY_TYPE_DB;
    }
    else
    {
        return DbDataManager_PQ::STRATEGY_TYPE_DATA;
    }
}
 ...
 *      复制超时时间
 */
int DbDataManager_PQ::GetStrategyCopyTimeout(string hcode, string strategyid)
{
    return BeGeneralLib::StringToInt(GetStrategyFieldValue(hcode, strategyid, DbDataManager_PQ::STRATEGY_TABLE_FIELD_COPYTIMEOUT));
}
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyExist(string hcode, string strategyid)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsVolumeHasStrategy(string hcode, string localmountpoint)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyHasDb(string strategyid)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyHasDb(string strategyid, string scheduleid)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyHasFull(string strategyid, string scheduleid)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyHasInclude(string strategyid, string scheduleid)
{
    string SqlString = string("SELECT COUNT(*) AS RECCOUNT FROM TBLCOPYDETAIL WHERE STRATEGYID = ") + strategyid + string(" AND SCHEDULEID = ") + scheduleid + string(" AND OPERATION = '+'");
    return GetFieldValueBool(SqlString, "RECCOUNT");
}
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyRac(string hcode, string strategyid)
{
    return (GetStrategyType(hcode, strategyid) == DbDataManager_PQ::STRATEGY_TYPE_RAC);
}
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyUsedForTimeout(string hcode, string strategyid)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsFinalStrategyInStorage(string hcode, string strategyid)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsStrategyHasCopy(string hcode, string strategyid)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddHost(string hcode, string name, string ipaddr, string ostype, string netbootprotocol, string netdefaultprotocol, string macaddr, string wwn, string port, string businessnicname,
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddHost(string localserverid, string remoteserverid, string hcode, string name, string macaddr, string ipaddr, string bootfile, string status,
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddHostNic(string originalserverid, string remoteserverid, string hcode, string macaddr, string devicename, string caption, string gateway, string maindns, string subdns,
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddHostIpAddress(string originalserverid, string remoteserverid, string hcode, string macaddr, string ip, string netmask, string ipv6, string netmaskv6, string workmode)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteHost(string hcode)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteHostRelativeRecord(string hcode)
{
    vector<string> SqlList;
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteHostSet()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHost(string hcode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHost(string hcode, string mac, string hdnum)
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHost(string localserverid, string remoteserverid, string hcode, string name, string macaddr, string ipaddr, string bootfile, string status,
        string isactive, string hdnum, string usingrhost, string rhostmac, string hbaipaddr, string isnetboot, string netdiskcapacity, string dbprotected, string ostype,
        string netbootprotocol, string netdefaultprotocol, string netbootservice, string fcwwn, string systemdir, string configdir, string vmmemory, string vmcpu, string listenport,
        string usedforrdr, string usedforle, string businessnicname, string brnicname, string storageid, string copymode, string syncflag, string fcname, string fcchannel,
        string initiatorname, string usedfornet, string usedforvm, string usedforfc, string cdpstate, string usedforea, string eamode, string heartbeattimeout,
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNic(string originalserverid, string remoteserverid, string hcode, string macaddr, string devicename, string caption, string gateway, string maindns, string subdns,
        string dhcpenabled, string isphysical, string status, string workmode, string usedforvm, string businessnic, string bridgenic, string virtualnetworkmode, string virtualmac)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostIpAddress(string originalserverid, string remoteserverid, string hcode, string macaddr, string ip, string netmask, string ipv6, string netmaskv6, string workmode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostStatus()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostOnlineStatus(string hcode, int status)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostCanEmergencyStatus(string hcode, DbDataManager_PQ::HostCanEmergencyStatus status)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostProtectedStatus(string hcode, DbDataManager_PQ::HostProtectedStatus status)
{
    string SqlString = string("UPDATE TBLHOST SET STATUS = ") + BeGeneralLib::Number2String(status) + string(" WHERE HCODE ='") + hcode + string("'");
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostBootProtocol(string hcode, string protocol)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostPort(string hcode, string port)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostLocalEmergencyStatus(string hcode, string status)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostBusinessNic(string hcode, string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostBridgeNic(string hcode, string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostReservedIp(string hcode, bool isusedreserved, string ipaddr)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostMacAddress(string hcode, string mac)
{
    vector<string> SqlList;
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostEAStatus(string hcode, string status)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostVirtualMac(string hcode, string virtualmac)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNicVirtualMac(string hcode, string mac, string virtualmac)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNicBussinessNicName(string hcode, string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNicBussinessNicName(string hcode, string mac, string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNicBridgeNicName(string hcode, string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNicBridgeNicName(string hcode, string mac, string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostNicUsedForVm(string hcode, string mac, bool usedforvm)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostVirtualNetworkMode(string hcode, string mac, VirtualNetworkMode mode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostCopyMode(string hcode, DbDataManager_PQ::HostCopyMode copymode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostFc(string hcode, string fcname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostFc(string hcode, string fcname, string wwn)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostVmBootCopyMode(string hcode, DbDataManager_PQ::VmBootCopy mode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostVncNumber(string hcode, int vncnumber)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateHostUsedForMonitor(string hcode, bool isopen)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::ClearHostNetEmergency()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::ClearHostVmEmergency()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::ClearHostFcEmergency()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::ClearHostDbProtected()
{
 ...
 *      主机结果集
 */
pqxx::result DbDataManager_PQ::GetHostResultSet()
{

    return GetHostResultSet("", DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_ALL);
}
 ...
 *      主机结果集
 */
pqxx::result DbDataManager_PQ::GetHostResultSet(string nicname)
{

    return GetHostResultSet(nicname, DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_BUSINESS_NIC);
}
 ...
 *      主机结果集
 */
pqxx::result DbDataManager_PQ::GetHostResultSet(string searchvalue, DbDataManager_PQ::HostResultSetRetrieveType searchtype)
{
    string SqlString = "";
    string Condition = "";
    switch (searchtype)
    {
        case DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_BUSINESS_NIC:
        {
            Condition = string("BUSINESSNICNAME = BINARY '") + searchvalue + string("'");
            break;
        }
        case DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_ORIGINAL_SERVER_ID:
        {
            Condition = string("ORIGINALSERVERID = BINARY '") + searchvalue + string("'");
            break;
        }
        case DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_SERVER_ID:
        {
            Condition = string("SERVERID = '") + searchvalue + string("'");
            break;
        }
        case DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_FCNAME:
        {
            Condition = string("FCNAME = BINARY '") + searchvalue + string("'");
            break;
        }
        case DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_RACGROUPID:
        {
            Condition = string("RACGROUPID = '") + searchvalue + string("'");
            break;
        }
        case DbDataManager_PQ::HOST_RESULTSET_RETRIEVE_TYPE_ONLYFORBACKUP:
        {
 ...
 *      主机个数
 */
int DbDataManager_PQ::GetHostCount()
{

    return GetHostCount(DbDataManager_PQ::HOST_COUNT_RETRIEVE_TYPE_ALL);
}
 ...
 *      主机个数
 */
int DbDataManager_PQ::GetHostCount(DbDataManager_PQ::HostCountRetrieveType type)
{
 ...
 *      主机个数
 */
int DbDataManager_PQ::GetHostCount(DbDataManager_PQ::HostCountRetrieveType type, string excepthcode)
{
    string Condition = "";
    switch (type)
    {
        case DbDataManager_PQ::HOST_COUNT_RETRIEVE_TYPE_NET_EMERGENCY:
        {
            Condition = string("USEDFORNET = 1");
            break;
        }
        case DbDataManager_PQ::HOST_COUNT_RETRIEVE_TYPE_VM_EMERGENCY:
        {
            Condition = string("USEDFORVM = 1");
            break;
        }
        case DbDataManager_PQ::HOST_COUNT_RETRIEVE_TYPE_FC_EMERGENCY:
        {
            Condition = string("USEDFORFC = 1");
            break;
        }
        case DbDataManager_PQ::HOST_COUNT_RETRIEVE_TYPE_DB_PROTECTED:
        {
            Condition = string("DBPROTECTED = 1");
            break;
        }
        case DbDataManager_PQ::HOST_COUNT_RETRIEVE_TYPE_EA:
        {
 ...
 *      操作系统类型
 */
DbDataManager_PQ::HostOSType DbDataManager_PQ::GetHostOSType(string hcode)
{
 ...
 *      主机的ip地址
 */
string DbDataManager_PQ::GetHostIp(string hcode)
{
    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_IPADDR);
}

string DbDataManager_PQ::GetHostMirrorMode(string hcode)
{
    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_MIRRORMODE);
}

string DbDataManager_PQ::GetHostMirrorState(string hcode)
{
    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_MIRRORSTATE);
}
 ...
 *      主机的监听端口
 */
string DbDataManager_PQ::GetHostPort(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_LISTENPORT);
}
 ...
 *      主机名称
 */
string DbDataManager_PQ::GetHostName(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_HOSTNAME);
}
 ...
 *      wwn
 */
string DbDataManager_PQ::GetHostWWN(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_FCWWN);
}
 ...
 *      启动协议
 */
string DbDataManager_PQ::GetHostBootProtocol(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_NETBOOTPROTOCOL);
}
 ...
 *      默认网启协议
 */
string DbDataManager_PQ::GetHostNetDefaultProtocol(string hcode)
{
    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_NETDEFAULTPROTOCOL);
}
 ...
 *      主机的虚拟机内存
 */
int DbDataManager_PQ::GetHostVmMemory(string hcode)
{

    return BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_VMMEMORY));
}
 ...
 *      主机的虚拟机CPU
 */
int DbDataManager_PQ::GetHostVmCPU(string hcode)
{

    return BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_VMCPU));
}
 ...
 *      活动虚拟机内存总和
 */
int DbDataManager_PQ::GetActiveVmMemory()
{
 ...
 *      活动虚拟机内存CPU
 */
int DbDataManager_PQ::GetActiveVmCPU()
{
 ...
 *      主机mac地址
 */
string DbDataManager_PQ::GetHostMac(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_MACADDR);
}
 ...
 *      主机系统目录
 */
string DbDataManager_PQ::GetHostSystemDir(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_SYSTEMDIR);
}
 ...
 *      主机配置目录
 */
string DbDataManager_PQ::GetHostConfigDir(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_CONFIGDIR);
}
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostExist(string hcode)
{
 ...
 *      主机保护状态
 */
DbDataManager_PQ::HostProtectedStatus DbDataManager_PQ::GetHostProtectedStatus(string hcode)
{
//  return (DbDataManager_PQ::HostProtectedStatus)(BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_STATUS)));
    string SqlString = string("SELECT STATUS FROM TBLHOST WHERE HCODE = '") + hcode + string("'");
    return (DbDataManager_PQ::HostProtectedStatus)(BeGeneralLib::StringToInt(GetFieldValue(SqlString, "STATUS")));
}
 ...
 *      主机业务网卡名
 */
string DbDataManager_PQ::GetHostBusinessNicName(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_BUSINESSNICNAME);
}
 ...
 *      主机桥接网卡名
 */
string DbDataManager_PQ::GetHostBridgeNicName(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_BRNICNAME);
}
 ...
 *      主机操作系统类型编码
 */
string DbDataManager_PQ::GetHostOSTypeCode(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_OSTYPE);
}
 ...
 *      主机字段值
 */
map<string, string> DbDataManager_PQ::GetHostFieldValue(string hcode)
{
    vector<string> FieldList;
 ...
 *      主机应急副本结果集
 */
pqxx::result DbDataManager_PQ::GetHostEmergencyCopyResultSet(string hcode)
{
 ...
 *      主机存储路径
 */
string DbDataManager_PQ::GetHostStoragePath(string hcode)
{
 ...
 *      主机复制方式
 */
DbDataManager_PQ::HostCopyMode DbDataManager_PQ::GetHostCopyMode(string hcode)
{

    return (DbDataManager_PQ::HostCopyMode)(BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_COPYMODE)));
}
 ...
 *      主机备机ip
 */
string DbDataManager_PQ::GetHostReservedIp(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_HBAIPADDR);
}
 ...
 *      主机FC名称
 */
string DbDataManager_PQ::GetHostFCName(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_FCNAME);
}
 ...
 *      主机FC通道号
 */
string DbDataManager_PQ::GetHostFCChannel(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_FCCHANNEL);
}
 ...
 *      主机initiator名称
 */
string DbDataManager_PQ::GetHostInitiatorName(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_INITIATORNAME);
}
 ...
 *      网卡结果集
 */
pqxx::result DbDataManager_PQ::GetHostNetworkAdapterResultSet(string hcode)
{
 ...
 *      网卡个数
 */
int DbDataManager_PQ::GetHostNetworkAdapterCount(string hcode)
{
 ...
 *      IP地址结果集
 */
pqxx::result DbDataManager_PQ::GetHostIpAddressResultSet(string hcode)
{
 ...
 *      IP地址结果集
 */
pqxx::result DbDataManager_PQ::GetHostIpAddressResultSet(string hcode, string mac)
{
 ...
 *      主机自动应急模式
 */
DbDataManager_PQ::HostEAMode DbDataManager_PQ::GetHostEAMode(string hcode)
{

    return (DbDataManager_PQ::HostEAMode)(BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_EAMODE)));
}
 ...
 *      主机心跳超时时间
 */
int DbDataManager_PQ::GetHostHeartbeatTimeout(string hcode)
{

    return BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_HEARTBEATTIMEOUT));
}
 ...
 *      主机虚ip
 */
string DbDataManager_PQ::GetHostVirtualIp(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_VIRTUALIP);
}
 ...
 *      主机虚mac
 */
string DbDataManager_PQ::GetHostVirtualMac(string hcode)
{

    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_VIRTUALMAC);
}
 ...
 *      主机通讯网卡的虚拟mac
 */
string DbDataManager_PQ::GetHostCommunicationNicVirtualMac(string hcode)
{
 ...
 *      主机通讯网卡的网络模式
 */
string DbDataManager_PQ::GetHostCommunicationNicNetworkMode(string hcode)
{
 ...
 *      rac组编号
 */
string DbDataManager_PQ::GetHostRacGroupId(string hcode)
{
    return GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_RACGROUPID);
}
 ...
 *      应急时副本挂载方式
 */
DbDataManager_PQ::EmergencyLogonMode DbDataManager_PQ::GetHostEmergencyLogonMode(string hcode)
{

    return (DbDataManager_PQ::EmergencyLogonMode)(BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_EMERGENCYLOGONMODE)));
}
 ...
 *      虚拟机启动副本方式
 */
DbDataManager_PQ::VmBootCopy DbDataManager_PQ::GetHostVmBootCopyMode(string hcode)
{
    return (DbDataManager_PQ::VmBootCopy)(BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_VMBOOTCOPYMODE)));
}
 ...
 *      vnc号
 */
int DbDataManager_PQ::GetHostVncNumber(string hcode)
{

    return BeGeneralLib::StringToInt(GetHostFieldValue(hcode, DbDataManager_PQ::HOST_TABLE_FIELD_VNCNUMBER));
}
 ...
 *      操作系统类型
 */
DbDataManager_PQ::HostOSType DbDataManager_PQ::ConvertHostOsCodeToOsType(string oscode)
{
    if (oscode == DEFAULT_OSTYPE_WINDOWS ||
            oscode == DEFAULT_OSTYPE_WIN2K_XP_2K3 ||
            oscode == DEFAULT_OSTYPE_WIN2K8)
    {
        return DbDataManager_PQ::HOST_OS_TYPE_WINDOWS;
    }

    if (oscode == DEFAULT_OSTYPE_LINUX)
    {
        return DbDataManager_PQ::HOST_OS_TYPE_LINUX;
    }

    if (oscode == DEFAULT_OSTYPE_AIX)
    {
        return DbDataManager_PQ::HOST_OS_TYPE_AIX;
    }
    if (oscode == DEFAULT_OSTYPE_HPUX)
    {

        return DbDataManager_PQ::HOST_OS_TYPE_HPUX;
    }
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostNameExist(string name)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostIpExist(string ipaddr)
{
 ...
 */
bool DbDataManager_PQ::IsHostEmergency(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostNetworkAdapterForVm(string hcode, string mac)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostNetworkAdapterExist(string hcode, string mac)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostNetworkAdapterIpExist(string hcode, string mac, string ip, string mask)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostLocalEmergencyOpen(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostNetEmergencyOpen(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostVmEmergencyOpen(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostFcEmergencyOpen(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostOnlyForBackup(string hcode)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostHasBusinessTaskRunning(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostHWEmergencyOpen(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostRacGroupMaster(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostInitializeCopyed(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostInitializeCopyed(string hcode, string lmountpoint)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostRDROpen(string hcode)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsHostHasCDPProtection(string hcode)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsVirtualMacExists(string mac)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteDbStrategyDetail(string hcode)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteDbSchedule(string hcode)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteDbTask(string hcode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateDbProtectedStatus(string hcode, int status)
{
 ...
 *      数据库保护数
 */
int DbDataManager_PQ::GetDbCount(string hcode)
{
 ...
 *      数据库保护数
 */
int DbDataManager_PQ::GetDbCount()
{
 ...
 *      数据库保护状态
 */
int DbDataManager_PQ::GetDbProtectedStatus(string hcode)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsDbProtected(string hcode)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::HasEAOpenedHosts()
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::HasRdrOpenedHosts()
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddSchedule(string localserverid, string remoteserverid, string schedulename, string commandcode, string parameter, string hcode, string tasktype, string exectype, string execinterval, string intervalunit, string starttime, string nexttime, string status, string lasttime)
{
 ...
 *      删除成功返回true，否则返回false
 */
bool DbDataManager_PQ::DeleteSchedule(string hcode)
{
 ...
 *      增加成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateSchedule(string localserverid, string remoteserverid, string schedulename, string commandcode, string parameter, string hcode, string tasktype, string exectype,
 ...
 *      调度计划结果集
 */
pqxx::result DbDataManager_PQ::GetScheduleResultSet()
{
 ...
 *      调度计划结果集
 */
pqxx::result DbDataManager_PQ::GetScheduleResultSet(string serverid)
{
 ...
 *      调度计划字段值
 */
map<string, string> DbDataManager_PQ::GetScheduleFieldValue(string scheduleid)
{
 ...
 *      调度计划字段值
 */
map<string, string> DbDataManager_PQ::GetScheduleFieldValue(string serverid, string schedulename)
{
    vector<string> FieldList;
    FieldList.push_back("ORIGINALSERVERID");
    FieldList.push_back("SERVERID");
...
#if 0
void DbDataManager_PQ::MoveScheduleToTask(pqxx::connection sqlconn)
{
...
//  SqlString = string("UPDATE TBLSCHEDULE SET NEXTTIME = STARTTIME WHERE TO_DAYS(NEXTTIME) IS NULL");
    ...
    pqxx::result TempRs = GetResultSet(sqlconn, SqlStringSchedule);
...
//          BesLog::DebugPrint(string("SCHEDULEID STATUS")+ScheduleId+" "+BeGeneralLib::Number2String(Status), BesLog::LOG_MESSAGE_TYPE_INFO, false);
            ...
            pqxx::result StrategyRs = GetResultSet(SqlString);
            if (StrategyRs != NULL && StrategyRs->rowsCount() > 0)
            {
                while (StrategyRs->next())
                {
                    ...
                    {
                        DbDataManager_PQ::HostOSType OSType = GetHostOSType(HCode);
                        if (OSType == DbDataManager_PQ::HOST_OS_TYPE_AIX
                                || OSType == DbDataManager_PQ::HOST_OS_TYPE_HPUX)
                        {
            ...
            pqxx::result SyncTaskRs = GetResultSet(sqlconn, SqlString);
 ...
 */
bool DbDataManager_PQ::IsScheduleExist(string scheduleid)
{
 ...
 *      如果存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsScheduleExist(string serverid, string name)
{
 ...
 */
bool DbDataManager_PQ::AddSubnet(string subnet, string mask, string rangelow, string rangehigh, string serverip)
{
 ...
 *      如果成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateNicType(string nicname, DbDataManager_PQ::NicType nictype)
{
 ...
 *      网卡信息结果集
 */
pqxx::result DbDataManager_PQ::GetNetworkResultSet()
{
 ...
 *      网络参数
 */
map<string, string> DbDataManager_PQ::GetNetworkParameter(string nicname)
{
 ...
 *      子网结果集
 */
pqxx::result DbDataManager_PQ::GetSubnetResultSet()
{
 ...
 *      路由结果集
 */
pqxx::result DbDataManager_PQ::GetRouteResultSet()
{
 ...
 *      网卡ip
 */
string DbDataManager_PQ::GetNicIpAddr(string nicname)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsNicExist(string nicname)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsServerIpExist(string ipaddr)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsSubnetExist(string subnet, string mask)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::IsNicBridged(string nicname)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateOriginalServerId(string newserverid)
{
    vector<string> SqlList;
 ...
 *      服务器列表
 */
pqxx::result DbDataManager_PQ::GetServerList(DbDataManager_PQ::RemoteServerType type)
{
 ...
 *      字段列表
 */
map<string, string> DbDataManager_PQ::GetServerFieldValue(string serverid, DbDataManager_PQ::RemoteServerType servertype)
{
    vector<string> FieldList;
    FieldList.push_back("SERVERID");
 ...
 *      服务器ip
 */
string DbDataManager_PQ::GetServerIp(string serverid, DbDataManager_PQ::RemoteServerType servertype)
{
 ...
 *      服务器端口
 */
string DbDataManager_PQ::GetServerPort(string serverid, DbDataManager_PQ::RemoteServerType servertype)
{
 ...
 *      本机服务器id
 */
string DbDataManager_PQ::GetLocalServerId()
{
 ...
 *      字段列表
 */
bool DbDataManager_PQ::IsServerExist(string serverid)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsServerExist(string serverid, DbDataManager_PQ::RemoteServerType servertype)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsServerExist(DbDataManager_PQ::RemoteServerType servertype)
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsServerIdExistInLocal(string serverid)
{
 ...
 */
bool DbDataManager_PQ::AddAlarm(string hcode, string event, string content, DbDataManager_PQ::AlarmLevel level, string starttime, string endtime)
{
    int AlarmState = 0;
    if (level == DbDataManager_PQ::ALARM_LEVEL_INFORMATION || level == DbDataManager_PQ::ALARM_LEVEL_ATTENTION)
    {
        AlarmState = 1;
    }
 ...
 *      操作成功返回ture，否则返回false
 */
bool DbDataManager_PQ::UpdateAlarm(string alarmid, int reportstate)
{
 ...
 *      操作成功返回ture，否则返回false
 */
bool DbDataManager_PQ::UpdateAlarmReportState(DbDataManager_PQ::AlarmReportMode reportmode, string alarmid, DbDataManager_PQ::AlarmReportState reportstate)
{
    string SqlString = "";
    switch (reportmode)
    {
        case DbDataManager_PQ::ALARM_REPORT_MODE_BMS:
        {
        ...
        case DbDataManager_PQ::ALARM_REPORT_MODE_SMS:
        {
        ...
        case DbDataManager_PQ::ALARM_REPORT_MODE_MAIL:
        {
 ...
 *      报警结果集
 */
pqxx::result DbDataManager_PQ::GetAlarmResultSet()
{
    string SqlString =
 ...
 *      报警接收人结果集
 */
pqxx::result DbDataManager_PQ::GetAlarmReceiverResultSet()
{
 ...
 *      报警类型
 */
DbDataManager_PQ::AlarmMode DbDataManager_PQ::GetAlarmMode()
{
    string SqlString = string("SELECT ALARMMODE FROM TBLALARMCONFIG");

    return (DbDataManager_PQ::AlarmMode)(GetFieldValueInt(SqlString, "ALARMMODE"));
}
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::HasUnreportedAlarm()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStorageSpace()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStorageDeviceName(string storageid, string devicename)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStorageFileSystem(string storageid, string filesystem)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStorageMountPoint(string storageid, string path)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStorageCleanState(string storageid, bool cleaned)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateStorageCleanLimit(string storageid, int limit)
{
 ...
 *      存储空间字段值
 */
map<string, string> DbDataManager_PQ::GetStorageFieldValue(string storageid)
{
 ...
 *      已用存储空间
 */
string DbDataManager_PQ::GetUsedStorageSpace(string storageid)
{
 ...
 *      存储空间结果集
 */
pqxx::result DbDataManager_PQ::GetStorageSpaceResultSet()
{
 ...
 *      操作成功返回ture，否则返回false
 */
bool DbDataManager_PQ::IsStorageExist(string storageid)
{
 ...
 *      如果有返回ture，否则返回false
 */
bool DbDataManager_PQ::IsStorageHasCDP(string storageid)
{
 ...
 *      如果有返回ture，否则返回false
 */
bool DbDataManager_PQ::IsStorageNeedTimingSnapshot()
{
...
bool DbDataManager_PQ::ClearFCAdapter()
{
 ...
 *      成功返回true，否则返回false
 */
bool DbDataManager_PQ::AddFCAdapter(string fcname, string wwn, string desc)
{
 ...
 *      光纤卡结果集
 */
pqxx::result DbDataManager_PQ::GetFCResultSet()
{
 ...
 *      存储空间字段值
 */
map<string, string> DbDataManager_PQ::GetFCFieldValue(string fcname)
{
    // 设置sql语句
 ...
 *      fc的WWN
 */
string DbDataManager_PQ::GetFCWWN(string fcname)
{
 ...
 */
bool DbDataManager_PQ::IsFCNameExist(string fcname)
{
 ...
 *      如果存在返回ture，否则返回false
 */
bool DbDataManager_PQ::IsFCWWNExist(string wwn)
{
 ...
 *      虚拟主机结果集
 */
pqxx::result DbDataManager_PQ::GetVMHostResultSet()
{
 ...
 *      虚拟服务器id
 */
string DbDataManager_PQ::GetVMServerId(string hcode)
{
 ...
 */
bool DbDataManager_PQ::IsVMHostUsed(string hcode)
{
 ...
 *      设置的CDP个数
 */
bool DbDataManager_PQ::AddCDPConfig(int cdpnumber, int keeptime, int keepunit)
{
 ...
 *      设置的CDP个数
 */
int DbDataManager_PQ::GetCDPNumber()
{
 ...
 *      设置的CDP连续快照时间
 */
int DbDataManager_PQ::GetCDPKeepTime()
{
 ...
 *      设置的CDP连续快照时间单位
 */
int DbDataManager_PQ::GetCDPKeepUnit()
{
 ...
 *      cdp连续恢复点时间间隔
 */
int DbDataManager_PQ::GetCDPCheckpointInterval()
{
 ...
 *      存在返回true，否则返回false
 */
bool DbDataManager_PQ::IsCDPConfigExist()
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCDPSnapshotKeepTime(int keeptime, int keeptimeunit)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCDPNumber(int number)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateCDPCheckpointInterval(int interval)
{
 ...
 */
pqxx::result DbDataManager_PQ::GetHostHeartbeatMonitorItemResultSet(string hcode)
{
 ...
 *      配置参数列表
 */
map<string, string> DbDataManager_PQ::GetHWEmergencyConfig()
{
 ...
 *      如果成功返回主机编码，否则返回空
 */
string DbDataManager_PQ::GetHCodeBindByKeyId(string keyid)
{
 ...
 *      如果成功返回按键编号，否则返回空
 */
string DbDataManager_PQ::GetKeyIdBindByHCode(string hcode)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::HasHWEmergencyConfig()
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsKeyUsedForHost(string keyid)
{
 ...
 *      如果有返回true，否则返回false
 */
bool DbDataManager_PQ::IsHWEmergencyBind()
{
 ...
 *      命令字描述信息
 */
string DbDataManager_PQ::GetCommandDescription(string cmdcode)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateLicenseName(string license)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateLicenseAlarm(string alarm)
{
 ...
 *      更新成功返回true，否则返回false
 */
bool DbDataManager_PQ::UpdateLicenseNumber(int host, int db, int snapshot, int net, int vm, int fc, int cdp, int cdpkeeptime, int cdpkeepunit, int eanumber, string expireddate)
{
 ...
 *      Agent参数
 */
map<string, string> DbDataManager_PQ::GetAgentParameter(string nicname)
{
 ...
 *      Bes类型
 */
DbDataManager_PQ::BesType DbDataManager_PQ::GetBesType()
{
    string SqlString = string("SELECT BESTYPE FROM TBLBESINFORMATION");
    string Type = GetFieldValue(SqlString, "BESTYPE");
    if (Type == "100")
    {
        return DbDataManager_PQ::BES_TYPE_SERVER;
    }
    else if (Type == "200")
    {
        return DbDataManager_PQ::BES_TYPE_STARTER;
    }
    else
    {
 ...
 *      远程服务器ip
 */
string DbDataManager_PQ::GetRemoteServerIp()
{
 ...
 *      Bes总的虚拟机内存
 */
int DbDataManager_PQ::GetBesTotalVmMemory()
{
 ...
 *      Bes总的虚拟机cpu
 */
int DbDataManager_PQ::GetBesTotalVmCPU()
{
 ...
 *      授权最大主机数
 */
int DbDataManager_PQ::GetMaxHost()
{
 ...
 *      无
 */
void DbDataManager_PQ::SetParameter(string server, string user, string password, string dbname)
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::CheckDatabaseOK()
{
 ...
 *      如果是返回true，否则返回false
 */
bool DbDataManager_PQ::CheckDatabaseOK(string server, string user, string password, string dbname)
{
    try
    {
		pqxx::connection conn(string("dbname="+dbname+" hostaddr="+server+" user="+user+" password="+password));
 ...
 *      密码
 */
string DbDataManager_PQ::Password()
{
 ...
 *      数据库名
 */
string DbDataManager_PQ::DbName()
{
 ...
 *      数据库名
 */
bool DbDataManager_PQ::Export(string path)
{
 ...
 *      数据库名
 */
bool DbDataManager_PQ::Export(string user, string password, string path)
{
    // 检查数据库是否OK
 ...
 *      修复成功返回true，否则返回false
 */
bool DbDataManager_PQ::Repair(string user, string password)
{
    // 检查数据库是否OK
    if (CheckDatabaseOK(MyServer, user, password, MyDbName) == false) return false;
 ...
 */
bool DbDataManager_PQ::ResetAdminPassword()
{
    // 重置admin密码
 ...
 *      备份本地数据库
 */
void DbDataManager_PQ::BackupDatabase()
{
    // 读取配置文件中备份文件个数
 ...
 *      无
 */
void DbDataManager_PQ::DestroyResultSet(pqxx::result rs)
{
 ...
 *      执行成功返回字段值，否则返回空
 */
string DbDataManager_PQ::GetFieldValue(string sqlstring, string field)
{
    vector<string> FieldList;
 ...
 *      执行成功返回字段整数值，否则返回0
 */
int DbDataManager_PQ::GetFieldValueInt(string sqlstring, string field)
{
 ...
 */
bool DbDataManager_PQ::GetFieldValueBool(string sqlstring, string field)
{
 ...
 *      执行成功返回字段值列表
 */
map<string, string> DbDataManager_PQ::GetFieldValue(string sqlstring, vector<string> fldlist)
{
    ...
    pqxx::result TempRs = GetResultSet(sqlstring);
    try
    {
    
		//const int num_rows = TempRs.size();
        if (TempRs.size() > 0 )
        {
			pqxx::result::const_iterator row = TempRs.begin();
            for (int i = 0; i < fldlist.size(); i++)
            {
                string FieldName = fldlist[i];
                FieldValueList.insert(pair<string, string > (FieldName,  row[i].as<string>() ));
            }
        }
    }
    catch (const pqxx::sql_error &e)
...
map<string, string> DbDataManager_PQ::GetFieldValue(pqxx::connection sqlconn, string sqlstring, vector<string> fldlist)
{

    map<string, string> FieldValueList;
    if (BeGeneralLib::IsStringEmpty(sqlstring) == true || fldlist.size() == 0) return FieldValueList;

    pqxx::result TempRs = GetResultSet(sqlconn, sqlstring);
    try{
        if (TempRs.size() > 0 ){
			pqxx::result::const_iterator row = TempRs.begin();
            for (int i = 0; i < fldlist.size(); i++){
 ...
 *      结果集
 */
pqxx::result DbDataManager_PQ::GetResultSet(string sqlstring)
{
    // 打开数据库连接   MyServer, MyUser, MyPassword, MyDbName
    pqxx::connection conn(string("dbname="+MyDbName+" hostaddr="+MyServer+" user="+MyUser+" password="+MyPassword));//conn = OpenConnection();
	if(conn.is_open())	
	{  
		cout << "Connection succesful!" << endl;  
		cout << conn.options()<<endl;  
	...
	pqxx::work w(conn);  
	//pqxx::result res = w.exec(sqlstring);
 ...
 */
 #if 0
pqxx::result DbDataManager_PQ::GetResultSet(pqxx::connection sqlconn, string sqlstring)
{
    ...
    {
        // 创建查询对象
		pqxx::work w(sqlconn);// 查询对象
        //w = CreateStatement(sqlconn);
 ...
 */
bool DbDataManager_PQ::ExecuteSql(string sqlstring)
{
    vector<string> SqlList;
    SqlList.push_back(sqlstring);
 ...
 *      执行成功返回true，否则返回false
 */
bool DbDataManager_PQ::ExecuteSql(vector<string> sqllist)
{
    // 检查sql语句列表是否为空
    ...
    // 打开数据库连接
    pqxx::connection conn(string("dbname="+MyDbName+" hostaddr="+MyServer+" user="+MyUser+" password="+MyPassword));//SqlConn = OpenConnection();
    if(conn.is_open())  
    {  
        cout << "Connection succesful!" << endl;  
        cout << conn.options()<<endl;  
	...
	w.commit();
    //bool Flag = ExecuteSql(conn, sqllist);
...
bool DbDataManager_PQ::ExecuteSql_For_Redis(string sqlstring)
{
    vector<string> SqlList;
    SqlList.push_back(sqlstring);

    return ExecuteSql_For_Redis(SqlList);
}

bool DbDataManager_PQ::ExecuteSql_For_Redis(vector<string> sqllist)
{
    // 检查sql语句列表是否为空
    if (sqllist.empty() == true)
    {
	...
	pqxx::work w_redis(conn);

    // 执行sql语句
	for (int i = 0; i < sqllist.size(); i++)
	{
		w_redis.exec(sqllist[i]);
	}
...
void DbDataManager_PQ::ExecuteCommit_For_Redis()
{
    pqxx::connection conn(string("dbname="+MyDbName+" hostaddr="+MyServer+" user="+MyUser+" password="+MyPassword));//SqlConn = OpenConnection();
    if(conn.is_open())  
    {  
 ...
 */
 #if 0
bool DbDataManager_PQ::ExecuteSql(pqxx::connection sqlconn, string sqlstring)
{
    vector<string> SqlList;
    SqlList.push_back(sqlstring);
 ...
 *      执行成功返回true，否则返回false
 */
bool DbDataManager_PQ::ExecuteSql(pqxx::connection sqlconn, vector<string> sqllist)
{
#if 0
	if ( sqllist.empty())
	{
 ...
 */
 #if 0
pqxx::connection DbDataManager_PQ::OpenConnection()
{
 ...
 */
 #if 0
pqxx::connection  DbDataManager_PQ::OpenConnection(string server, string user, string password, string dbname)
{
    ...
    {
        // pqxx
        conn(string("dbname="+dbname+" hostaddr="+server+" user="+user+" password="+password));
        if(conn.is_open())  
        {  
            cout << "Connection succesful!" << endl;  
            cout << conn.options()<<endl;  
 ...
 */
 #if 0
void DbDataManager_PQ::CloseConnection(pqxx::connection sqlconn)
{
 ...
 *      sqlconn         :   数据库连接对象
 *  返回：
 *      如果成功返回work对象，否则返回null
 */
 #if 0
pqxx::work DbDataManager_PQ::CreateStatement(pqxx::connection sqlconn)
{
    ...
    try
    {
        ...
        // 设置字符集
        sqlconn.set_client_encoding("GBK");
 ...
 */
 #if 0
void DbDataManager_PQ::CloseStatement(pqxx::connection sqlstatement)
{
    try
    {
 ...
 *      字段名
 */
string DbDataManager_PQ::GetSnapshotFieldName(DbDataManager_PQ::SnapshotTableField field)
{
    string FieldName = "";
    switch (field)
    {
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SNAPSHOTID: // 快照编号
        {
            FieldName = string("SNAPSHOTID");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_LMOUNTPOINT: // 主机挂载点
        {
            FieldName = string("LMOUNTPOINT");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SNAPTYPE: // 快照类型
        {
            FieldName = string("SNAPTYPE");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_TRUSTED: // 是否可信
        {
            FieldName = string("TRUSTED");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_CHECKPOINTID: // 检查点id
        {
            FieldName = string("CHECKPOINTID");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SYNCCOPYID: // 同步副本id
        {
            FieldName = string("SYNCCOPYID");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SNAPSHOTSOURCE: // 快照源
        {
            FieldName = string("SNAPSHOTSOURCE");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SNAPSHOTLUNID: // 快照lun编号
        {
            FieldName = string("SNAPSHOTSOURCE");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_STARTTIME: // 开始时间
        {
            FieldName = string("STARTTIME");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_ENDTIME: // 结束时间
        {
            FieldName = string("ENDTIME");
            break;
        }
        case DbDataManager_PQ::SNAPSHOT_TABLE_FIELD_SYNCSTATE: // 远程同步状态
        {
 ...
 *      快照记录字段值
 */
string DbDataManager_PQ::GetSnapshotFieldValue(string hcode, string snapshotid, DbDataManager_PQ::SnapshotTableField field)
{
 ...
 *      字段名
 */
string DbDataManager_PQ::GetCopyFieldName(DbDataManager_PQ::CopyTableField field)
{
    string FieldName = "";
    switch (field)
    {
        case DbDataManager_PQ::COPY_TABLE_FIELD_SNAPSHOTID: // 快照编号
        {
            FieldName = string("SNAPSHOTID");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_LMOUNTPOINT: // 主机挂载点
        {
            FieldName = string("LMOUNTPOINT");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_IQN: // iqn
        {
            FieldName = string("IQN");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_TARGETFILE: // target文件
        {
            FieldName = string("TARGETFILE");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_MOUNTPOINT: // 挂载点
        {
            FieldName = string("MOUNTPOINT");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_USED: // 副本状态
        {
            FieldName = string("USED");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_COPYTYPE: // 副本类型
        {
            FieldName = string("COPYTYPE");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_COPYLUNID: // 副本lun编号
        {
            FieldName = string("COPYLUNID");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_CAPACITY: // 副本容量
        {
            FieldName = string("CAPACITY");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_SENDERCOPYID: // 发送端副本编号
        {
            FieldName = string("SENDERCOPYID");
            break;
        }
        case DbDataManager_PQ::COPY_TABLE_FIELD_FSNAME: // zfs文件系统名称
        {
 ...
 *      副本记录字段值
 */
string DbDataManager_PQ::GetCopyFieldValue(string hcode, string copyid, DbDataManager_PQ::CopyTableField field)
{
 ...
 *      字段名
 */
string DbDataManager_PQ::GetHostFieldName(DbDataManager_PQ::HostTableField field)
{
    string FieldName = "";
    switch (field)
    {
        case DbDataManager_PQ::HOST_TABLE_FIELD_HOSTNAME: // 主机名
        {
            FieldName = string("HOSTNAME");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_MACADDR: // 主机mac地址
        {
            FieldName = string("MACADDR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_IPADDR: // 主机ip地址
        {
            FieldName = string("IPADDR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_STATUS: // 保护状态
        {
            FieldName = string("STATUS");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_ISACTIVE: // 是否为激活
        {
            FieldName = string("ISACTIVE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_HBAIPADDR: // HBA卡的ip地址
        {
            FieldName = string("HBAIPADDR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_DBPROTECTED: // 数据库是否保护标志
        {
            FieldName = string("DBPROTECTED");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_OSTYPE: // 操作系统类型
        {
            FieldName = string("OSTYPE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_NETBOOTPROTOCOL: // 启动协议
        {
            FieldName = string("NETBOOTPROTOCOL");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_NETDEFAULTPROTOCOL: // 默认网启协议
        {
            FieldName = string("NETDEFAULTPROTOCOL");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_FCWWN: // 主机光纤卡WWN
        {
            FieldName = string("FCWWN");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_SYSTEMDIR: // 系统目录
        {
            FieldName = string("SYSTEMDIR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_CONFIGDIR: // 配置目录
        {
            FieldName = string("CONFIGDIR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_VMMEMORY: // 虚拟机内存
        {
            FieldName = string("VMMEMORY");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_VMCPU: // 虚拟机CPU个数
        {
            FieldName = string("VMCPU");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_LISTENPORT: // 监听端口
        {
            FieldName = string("LISTENPORT");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFORRDR: // 用于容灾
        {
            FieldName = string("USEDFORRDR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFORLE: // 用于本地应急
        {
            FieldName = string("USEDFORLE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_BUSINESSNICNAME: // 业务网卡名
        {
            FieldName = string("BUSINESSNICNAME");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_BRNICNAME: // 桥接网卡名
        {
            FieldName = string("BRNICNAME");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_COPYMODE: // 复制方式
        {
            FieldName = string("COPYMODE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_SYNCFLAG: // 同步主机信息标志
        {
            FieldName = string("SYNCFLAG");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_FCNAME: // 光纤卡名称
        {
            FieldName = string("FCNAME");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_FCCHANNEL: // 光纤通道号
        {
            FieldName = string("FCCHANNEL");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_INITIATORNAME: // initiator名称
        {
            FieldName = string("INITIATORNAME");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFORNET: // 用于网启应急
        {
            FieldName = string("USEDFORNET");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFORVM: // 用于虚拟机应急
        {
            FieldName = string("USEDFORVM");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFORFC: // 用于光纤卡应急
        {
            FieldName = string("USEDFORFC");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFOREA: // 是否用于自动应急
        {
            FieldName = string("USEDFOREA");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_EAMODE: // 自动应急方式
        {
            FieldName = string("EAMODE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_HEARTBEATTIMEOUT: // 心跳超时时间
        {
            FieldName = string("HEARTBEATTIMEOUT");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_QUERYINTERVAL: // 查询间隔
        {
            FieldName = string("QUERYINTERVAL");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_VIRTUALIP: // 虚拟ip
        {
            FieldName = string("VIRTUALIP");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_VIRTUALMAC: // 虚拟mac地址
        {
            FieldName = string("VIRTUALMAC");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_RACGROUPID: // rac组编号
        {
            FieldName = string("RACGROUPID");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_EMERGENCYLOGONMODE: // 应急时副本挂载方式
        {
            FieldName = string("EMERGENCYLOGONMODE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_USEDFORMONITOR: // 是否用于监控
        {
            FieldName = string("USEDFORMONITOR");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_ISAUTOTAKEOVER: // 是否自动接管
        {
            FieldName = string("ISAUTOTAKEOVER");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_VMBOOTCOPYMODE: // 虚拟机启动副本模式
        {
            FieldName = string("VMBOOTCOPYMODE");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_VNCNUMBER: // vnc号
        {
            FieldName = string("VNCNUMBER");
            break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_MIRRORMODE: // 镜像类型
        {
        	FieldName = string("MIRRORMODE");
        	break;
        }
        case DbDataManager_PQ::HOST_TABLE_FIELD_MIRRORSTATE: // 镜像状态
        {
 ...
 *      字段名
 */
string DbDataManager_PQ::GetHostFieldValue(string hcode, DbDataManager_PQ::HostTableField field)
{
 ...
 *      字段名
 */
string DbDataManager_PQ::GetStrategyFieldName(DbDataManager_PQ::StrategyTableField field)
{
    string FieldName = "";
    switch (field)
    {
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_STRATEGYTYPE: // 策略类型
        {
            FieldName = string("STRATEGYTYPE");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_CAPACITY: // 策略卷大小
        {
            FieldName = string("CAPACITY");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_SSCOPYID: // 应急副本id
        {
            FieldName = string("SSCOPYID");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_TRUSTEDCOPYID: // 可信副本id
        {
            FieldName = string("TRUSTEDCOPYID");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_MIRRORLUNID: // MIRROR盘的LUNID
        {
            FieldName = string("MIRRORLUNID");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_MMLUNID: // MIRROR的MIRROR盘的LUNID
        {
            FieldName = string("MMLUNID");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_VOLUMEPAIRID: // 卷对id
        {
            FieldName = string("VOLUMEPAIRID");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_CURRENTVOLUMETYPE: // 当前卷类型
        {
            FieldName = string("CURRENTVOLUMETYPE");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_USEDFORCDP: // 是否用于CDP
        {
            FieldName = string("USEDFORCDP");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_CDPSTATE: // CDP状态
        {
            FieldName = string("CDPSTATE");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_MAXSNAPSHOT: // 最大快照数
        {
            FieldName = string("MAXSNAPSHOT");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_USEDFORTIMEOUT: // 是否设置复制超时
        {
            FieldName = string("USEDFORTIMEOUT");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_COPYTIMEOUT: // 复制超时时间
        {
            FieldName = string("COPYTIMEOUT");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_CDPMODE: // CDP模式
        {
            FieldName = string("CDPMODE");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_DEVICEMINOR: // 设备号
        {
            FieldName = string("DEVICEMINOR");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_STGID:// 存储空间编号
        {
            FieldName = string("STGID");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_STG_DEVICE:// 存储空间设备
        {
            FieldName = string("DEVICE");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_STG_MOUNTPOINT:// 存储空间挂载点
        {
            FieldName = string("MOUNTPOINT");
            break;
        }
        case DbDataManager_PQ::STRATEGY_TABLE_FIELD_STG_FSTYPE: // 存储空间文件系统
        {
 ...
 *      字段名
 */
string DbDataManager_PQ::GetStrategyFieldValue(string hcode, string strategyid, DbDataManager_PQ::StrategyTableField field)
{
 ...
 *      字段值
 */
map<string, string> DbDataManager_PQ::GetStrategyFieldValue(string hcode, string strategyid)
{
    string LMountPoint = GetHostMountPoint(hcode, strategyid);
 ...
 *      字段名字符串
 */
string DbDataManager_PQ::GetFieldNameString(vector<string> fieldlist)
{
 ...
 *      字段名字符串
 */
string DbDataManager_PQ::GetFieldNameString(vector<string> fieldlist, char seperator)
{
 ...
 *      字段名字符串
 */
string DbDataManager_PQ::GetFieldNameString(vector<string> fieldlist, string seperator)
{
 ...
 *      无
 */
void DbDataManager_PQ::CheckDatabaseBackupPath(string path, string filename, int backupnum)
{
    // 检查路径是否以路径分割符结尾，如果不是，则添加后缀路径分割符
 ...
 *      表名
 */
string DbDataManager_PQ::GetTableName(string hcode, DbDataManager_PQ::TableType type)
{
    ...
    switch (type)
    {
        case DbDataManager_PQ::TABLE_TYPE_VOLUME:
        {
            switch (OsType)
            {
                case DbDataManager_PQ::HOST_OS_TYPE_LINUX:
        ...
        case DbDataManager_PQ::TABLE_TYPE_SNAPSHOT:
        {
            switch (OsType)
            {
                case DbDataManager_PQ::HOST_OS_TYPE_WINDOWS:
        ...
        case DbDataManager_PQ::TABLE_TYPE_SNAPSHOTCOPY:
        {
            switch (OsType)
            {
                case DbDataManager_PQ::HOST_OS_TYPE_WINDOWS:
...
// 获取报警条件
map<string, string> DbDataManager_PQ::GetAlarmRule(string hcode)
{
    vector<string> FieldList;
...
pqxx::result DbDataManager_PQ::GetMonitorPort(string hcode)
{
...
pqxx::result DbDataManager_PQ::GetMonitorService(string hcode)
{
...
pqxx::result DbDataManager_PQ::GetMonitorProcess(string hcode)
{
...
map<string, string> DbDataManager_PQ::GetSoftOffParam(string hcode){
...
bool DbDataManager_PQ::AddSelfCheckLog(string content, BesError::SelfCheckResult state){
	string State="";
	switch(state){
...
bool DbDataManager_PQ::AddDockerImage(string hcode, string hostip, string imagename, string imageid, string copyid, string targetfile, string mountpoint)
{
...
bool DbDataManager_PQ::DeleteDockerImage(string imageid)
{
    string SqlString = string("DELETE FROM TBLDOCKERIMG WHERE DOCKERIMGID='")+ imageid + string("'");
    return ExecuteSql(SqlString);
}

bool DbDataManager_PQ::AddDockerContainer(string hcode, string containerid, string containername, string hostip, string imageid, string state)
{
...
bool DbDataManager_PQ::DeleteDockerContainer(string containerid){
	return ExecuteSql("DELETE FROM TBLDOCKERCONTAINER WHERE CONTAINERID='" + containerid + "'");
}

map<string, string> DbDataManager_PQ::GetDockerImageValue(string hcode, string copyid){
...
bool DbDataManager_PQ::UpdateDbImageProtect(string hcode, string mirrorserverip, string mirrordbip, string mirrormode, DbDataManager_PQ::DBMirrorState mirrorstate)
{
...
bool DbDataManager_PQ::UpdateDbMirrorState(string hcode, DbDataManager_PQ::DBMirrorState mirrorstate)
{
...
map<string, string> DbDataManager_PQ::GetMirrorInfo(string hcode){
...
//清除rac组首选主机
bool DbDataManager_PQ::ClearRacGroupMasterHost(string groupid)
{
    return UpdateRacGroupMasterHost(groupid, "?");
}

//更新rac组首选主机
bool DbDataManager_PQ::UpdateRacGroupMasterHost(string groupid, string hcode)
{
...
//获取rac组首选主机的主机编码
string DbDataManager_PQ::GetRacGroupMasterHost(string groupid)
{
...
bool DbDataManager_PQ::IsRacGroupExist(string groupid)
{
...
//检查rac的磁盘是否存在
bool DbDataManager_PQ::IsRacDiskExist(string hcode, string disksysmbol)
{
    string SqlString = string("SELECT COUNT(*) AS RECCOUNT FROM TBLDISK WHERE HCODE = '") + hcode + string("' AND DISKSYMBOL ='") + disksysmbol + string("'");
    return GetFieldValueBool(SqlString, "RECCOUNT");
}

bool DbDataManager_PQ::ChangeHostIpAddr(string hcode, string newip)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
bool DbDataManager_PQ::DeleteExpiredTask()
{
...
//准备执行、正在执行-->完成+失败
bool DbDataManager_PQ::UpdateUncompletedTask()
{
...
//获取任务结果集
pqxx::result DbDataManager_PQ::GetTaskResultSet()
{
    string SqlString = string("SELECT TASKID, COMMANDCODE, PARAMETER, STATUS, MAXCOUNTER FROM TBL_TASK WHERE STATUS = 0 ORDER BY TASKID");
    return GetResultSet(SqlString);
}
#if 0
bool DbDataManager_PQ::CreateSourceTable(string source)
{
	vector<string> SqlList;
...
bool DbDataManager_PQ::CreateStrategyTable(string strategy)
{
...
//	create table TBL_TRUNKDATA_ (like TBL_TRUNKDATA including constraints including indexes including defaults);
	SqlString="create table if not exists TBL_TRUNKDATA_"+source+" (like TBL_TRUNKDATA including constraints including indexes including defaults)";
	SqlList.push_back(SqlString);

	//SqlString="create table if not exists TBL_TEMP_"+source+" (like TBL_TRUNKDATA including constraints including indexes including defaults)";
	//SqlList.push_back(SqlString);

	SqlString="create table if not exists TBL_PRE_TEMP_"+source+" (like TBL_TRUNKDATA including constraints including indexes including defaults)";
	SqlList.push_back(SqlString);
...
bool DbDataManager_PQ::CreateStrategyTable(string strategy)
{
	...
	SqlString="create table if not exists TBL_DONETRANS_"+strategy+" (like TBL_DONETRANS including constraints including indexes including defaults)";
	SqlList.push_back(SqlString);
	
	SqlString="create table if not exists TBL_ERRORSQL_"+strategy+" (like TBL_ERRORSQL including constraints including indexes including defaults)";
	SqlList.push_back(SqlString);
...
bool DbDataManager_PQ::CheckCommitAndInsertDelete(string souceId,string xid)
{
	vector<string> SqlList;
	string SqlString;
	...
	//insert into TBL_TRUNKDATA_2 select * from TBL_TRUNKDATA_1 where xid ='0A000A0012990000';
	SqlString =  string("INSERT INTO TBL_TRUNKDATA_")+souceId+string(" SELECT * FROM TBL_TEMP_")+souceId+string(" WHERE xid = '")+xid+string("'");
	SqlList.push_back(SqlString);
	
	SqlString =  string("DELETE FROM TBL_TEMP_")+souceId+string(" WHERE xid = '")+xid+string("'");
	SqlList.push_back(SqlString);

	return ExecuteSql(SqlList);
}

bool DbDataManager_PQ::CheckROLLBACKToDelete(string souceId,string xid)
{
	vector<string> SqlList;
	string SqlString;
...
pqxx::result DbDataManager_PQ::GetXIDBYROLLBACK(string souceId)
{
    string SqlString = string("SELECT XID FROM TBL_TEMP_"+souceId+" WHERE OPERATION_CODE = '36'");
    return GetResultSet(SqlString);
}



pqxx::result DbDataManager_PQ::GetXIDBYOPERATION_CODE(string souceId)
{
    string SqlString = string("SELECT XID FROM TBL_TEMP_"+souceId+" WHERE OPERATION_CODE = '7'");
    return GetResultSet(SqlString);
}

pqxx::result DbDataManager_PQ::GetSourceDB_SID()
{
    string SqlString = string("SELECT SID FROM TBL_SOURCE_DB ORDER BY SID");
    return GetResultSet(SqlString);
}

bool DbDataManager_PQ::GETCOMMITINSERTINTOTRUNKTABLE(string Sql,string sourceid)
{
#if 0
	string buf_mid;
	string SqlString="SELECT column_name  FROM information_schema.columns  WHERE table_name = 'tbl_trunkdata' ";
	...
	if (TempRs.size() > 0)
	{
		for (pqxx::result::const_iterator row = TempRs.begin(); row != TempRs.end(); ++row)
		{
			...
			{
				//continue;
				//buf_mid=buf_mid+row[0].as<string>() ;
	...
	string fieldstr=buf_mid;
	SqlString="insert into tbl_trunkdata_"+sourceid+"("+fieldstr+")"+"values ("+Sql+")";
	cout << "SqlString="+SqlString << endl;
#endif
	return ExecuteSql_For_Redis(Sql);
}
#if 1
string DbDataManager_PQ::GETCOMMITINSERTINTOsql(string Sql,string sourceid)
{
	string buf_mid;
	string SqlString="SELECT column_name  FROM information_schema.columns  WHERE table_name = 'tbl_trunkdata' ";
	...
	return SqlString;//ExecuteSql_For_Redis(SqlString);
}


#endif
#endif
bool DbDataManager_PQ::UpdateExtractorProcess(string source, string pid)
{
	string SqlString = string("UPDATE TBL_SOURCE_DB SET PROCESS_CAP=") + pid + string(" WHERE SID=") + source;
	return ExecuteSql(SqlString);
}

bool DbDataManager_PQ::UpdateTRANSPORTProcess(string source, string pid)
{
...
string DbDataManager_PQ::GetLoaderProcess(string strategy)
{
...
pqxx::result DbDataManager_PQ::GetSourceDBResultSet()
{
    string SqlString = string("SELECT SID,DBTYPE,TRUNK_TABLE FROM TBL_SOURCE_DB ORDER BY SID");
    return GetResultSet(SqlString);
}

pqxx::result DbDataManager_PQ::GetSourceDBForScnRefresh()
{
    string SqlString = string("SELECT SID,SIP,USERNAME,INSTANCENAME,PASSWORD,TSNAME FROM TBL_SOURCE_DB ORDER BY SID");
    return GetResultSet(SqlString);
}

bool DbDataManager_PQ::UpdateNowScn(string now_scn, string sid)
{
	string SqlString = string("UPDATE TBL_SOURCE_DB SET NOW_SCN="+ now_scn + " where SID= ") + sid;
	return ExecuteSql(SqlString);
}
bool DbDataManager_PQ::UpdateNowTime(string now_time, string sid)
{
...
//自动启动的源库ID
pqxx::result DbDataManager_PQ::GetAutostartSourceDBResultSet()
{
//  string SqlString = string("SELECT SID FROM TBL_SOURCE_DB ORDER BY SID");
...
bool DbDataManager_PQ::IsStrategyS2DExist(string sourceid,string desid)
{
...
#if 0
bool DbDataManager_PQ::DeleteExpiredTrunkData(string source)
{
...
pqxx::result DbDataManager_PQ::GetStrantegyDBResultSet(string sourceid)
{
    string SqlString = string("SELECT STRATEGY_ID FROM TBL_STRATEGY WHERE SID=" + sourceid);
    return GetResultSet(SqlString);
}

pqxx::result DbDataManager_PQ::GetMaxPidByStrantegyIDResultSet(string strantegyid)
{
    string SqlString = string("SELECT MAX(PID) AS MAXPID FROM TBL_DONETRANS_" + strantegyid);
    return GetResultSet(SqlString);
}

pqxx::result DbDataManager_PQ::GetCountPidByStrantegyIDResultSet(string strantegyid)
{
    string SqlString = string("SELECT COUNT(*) AS COUNTPID FROM TBL_TRUNKDATA_" + strantegyid);
    return GetResultSet(SqlString);
}

bool DbDataManager_PQ::DeleteTrunkDataByMaxPid(string Max_pid,string source)
{
...
bool DbDataManager_PQ::DeleteExpiredTrunkData(string source)
{
	...
	string ShellCommand;
	bool flag;
	pqxx::result DBResultSet_COUNT;	
	pqxx::result DBResultSet;
	...
	{	
        for (pqxx::result::const_iterator row = DBResultSet.begin(); row != DBResultSet.end(); ++row)
        {
			STRATEGY_ID=row[0].as<string>();
        }
		...
		DBResultSet_COUNT=GetCountPidByStrantegyIDResultSet(source);
		if (DBResultSet.size() > 0&& DBResultSet_COUNT.size() > 0)
		{
			for (pqxx::result::const_iterator row = DBResultSet.begin(); row != DBResultSet.end(); ++row)
	        {
				MAXPID=row[0].as<string>();
	        }
			for (pqxx::result::const_iterator row = DBResultSet_COUNT.begin(); row != DBResultSet_COUNT.end(); ++row)
	        {
				COUNTPID=row[0].as<string>();
	        }
			//shell  when  COUNTPID > default dump
			cout<<"MAXPID="<<MAXPID<<endl;
			cout<<"COUNTPID="<<BeGeneralLib::StringToInt(COUNTPID)<<endl;
			if(BeGeneralLib::StringToInt(COUNTPID)>Default_Max_Count)
			{
				BesLog::DebugPrint("mysqldump--begin---!", BesLog::LOG_MESSAGE_TYPE_INFO);
				string time_dump =BeGeneralLib::GetTimeString(BeGeneralLib::TIME_FORMAT_FULL_DATE);
				//mysqldump -h127.0.0.1 -uroot -ppcbtrams wangdl_test TBL_TRUNKDATA_5 --single-transaction --quick > /home/dss/trunkdata102020.sql
				ShellCommand = string("mysqldump -h")+Host_Dump+string(" -U")+UserName_Dump+string(" -W")+Password_Dump+string(" ")+DbName_Dump+string(" TBL_TRUNKDATA_")+source + string(">/home/dss/sql/trunkdata_"+source+"-"+time_dump+".sql");
				...
				if(flag)
				{
					...
					DeleteTrunkDataByMaxPid(MAXPID,source);
				}
				else
				{
...
bool DbDataManager_PQ::AddTask(string cmdcode, string parameter)
{
    string SqlString = string("INSERT INTO TBL_TASK(COMMANDCODE, PARAMETER, CREATETIME) VALUES('") + cmdcode + "','" + parameter + "',NOW())";
    return ExecuteSql(SqlString);
}

bool DbDataManager_PQ::DeleteStrategy(string strategy)
{
	string SqlString = string("DELETE FROM TBL_STRATEGY WHERE STRATEGY_ID=") + strategy;
	return ExecuteSql(SqlString);
}

bool DbDataManager_PQ::AddStrategy(string strategyname,string sid,string did,string scn,string syncusers,string interval,string errorskip,string autostart)
{
...
bool DbDataManager_PQ::DeleteSourceDB(string source)
{
	string SqlString = string("DELETE FROM TBL_SOURCE_DB WHERE SID=") + source;
	return ExecuteSql(SqlString);
}

bool DbDataManager_PQ::AddSourceDB(vector<string> ParaArray)
{
...
string DbDataManager_PQ::GetStrategyCreateTime(string strategy)
{
    string SqlString;
	if(strategy != "")
